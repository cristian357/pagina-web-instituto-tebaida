...
if (!isset($_SESSION['profesor'])) {
    header("Location: ../logeo/profesor/inicio.php");
    exit();
}
...
$re = mysqli_query($conexion, "SELECT * FROM profesor WHERE id_profesor  = $id");
...
<header>
 ...
 <h1 class="titulo">👨‍🏫 Perfil del profesor</h1>
</header> 
</div>
    <nav>
        <ul class="menu">
...
<div class="profile-container">
    <div class="profile-header">
        ...
        <div class="profile-actions">
            ...
            <a href="eliminar.php?id=<?= $id ?>" onclick="return confirm('¿Eliminar profesor?')" class="btn delete">🗑️ Eliminar</a>
        </div>
    </div>

    <div class="profile-card">
        <table>
            <tr><th>ID</th><td><?= $ro['id_profesor'] ?></td></tr>
            <tr><th>Nombre</th><td><?= $ro['nombre_profesor'] ?></td></tr>
            <tr><th>Apellido</th><td><?= $ro['apellido_profesor'] ?></td></tr>
            <tr><th>Teléfono</th><td><?= $ro['telefono_profesor'] ?></td></tr>
            <tr><th>Correo</th><td><?= $ro['correo_profesor'] ?></td></tr>
            <tr><th>Grupo</th><td><?= $ro['id_profesor'] ?></td></tr>
        </table>
    </div>
